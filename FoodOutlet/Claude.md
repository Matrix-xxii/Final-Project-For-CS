...
dont change project structure.In role.cshtml,it has form,list and script for data get or set like that.if data get or set,should have script in that page.
my project has two part one is admin dashboard and user view.Layout is for admin dashboard and LayoutWeb is for user view.table is for user view.
